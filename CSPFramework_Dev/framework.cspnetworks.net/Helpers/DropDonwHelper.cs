...
=======
        public static IEnumerable<SelectListItem> GetCSPUsers(String dropDownApiMethod, String selectedValue)
        {
            ...
            var values = dictionary.Keys.ToArray();
            var names= dictionary.Values.ToArray();
        ...
        public static IEnumerable<SelectListItem> GetClientSitesList(int? clientId, String selectedValue)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                // HTTP GET                     
                response = client.GetAsync("api/DropDowns/GetSites?id=" + clientId).Result;
            }
